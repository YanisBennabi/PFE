...
<header class="main-header">
  ...
  <aside class="sidebar">
    ...
    if ($role_clean === 'chef departement'): ?>
        <a href="../chef/dashboard.php" class="sidebar-item"><i class="bi bi-speedometer2"></i> <span>Tableau de bord</span></a>
        ...
        <div class="sidebar-submenu" id="submenuInventaire">
            <a href="../chef/inventaire.php" class="sidebar-subitem"><i class="bi bi-pc-display"></i> Équipements</a>
        ...
        <div class="sidebar-submenu" id="submenuAdmin">
            <a href="../chef/utilisateurs.php" class="sidebar-subitem"><i class="bi bi-people"></i> Utilisateurs</a>
            <a href="../chef/gestion_vacataires.php" class="sidebar-subitem"><i class="bi bi-person-plus"></i> Comptes vacataires</a>
        </div>

    <?php 
    // --- SIDEBAR POUR ENSEIGNANT[cite: 14] ---
    elseif ($role_clean === 'enseignant' || $role_clean === 'vacataire' ): ?>
        ...
        <div class="sidebar-submenu" id="submenuPannes">
            <a href="../enseignant/signaler_panne.php" class="sidebar-subitem"><i class="bi bi-exclamation-triangle"></i> Signaler une panne</a>
            <a href="../enseignant/mes_signalements.php" class="sidebar-subitem"><i class="bi bi-list-check"></i> Mes signalements</a>
        </div>

    <?php 
    // --- SIDEBAR POUR SERVICE ENSEIGNEMENT[cite: 15] ---
    elseif ($role_clean === 'service enseignement'): ?>
        <a href="../service/index.php" class="sidebar-item"><i class="bi bi-house"></i> <span>Accueil</span></a>
        ...
        <div class="sidebar-submenu" id="submenuPlannings">
            ...
            <a href="../service/labos.php" class="sidebar-subitem"><i class="bi bi-building"></i> Laboratoires</a>
        </div>
